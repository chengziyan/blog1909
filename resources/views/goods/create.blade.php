...
<a href="{{url('/goods/index')}}" type="button" class="btn btn-warning">列表</button></a>
...
{{csrf_field()}}
    ...
    <div class="form-group">
     ...
     <div class="form-group">
		...
		<div class="col-sm-8">
            <input type="radio"   name="is_huan" value="1" checked>是
            <input type="radio"   name="is_huan" value="2">否
		</div>
    </div>
     <div class="form-group">
